...
<div class="p-6">
    ...
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Data Dosen Wali</h1>
...
function openDetail(dosen, nama, kelas){
    document.getElementById('detailModal').classList.remove('hidden')
    document.getElementById('detailNidn').innerText = dosen
